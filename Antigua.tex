...
\beginsong{Fanchon}[by={Populaire - Oscar},sr={}]

\beginverse
\[G]A\[C]mis, il \[G]faut \[D]faire une \[G]pau-au-se
\[G]J'aperçois l'ombre d'un bouchon
\[F]Buvons à l\[G]'aimable \[C]Fanchon
Chantons\[G] pour elle\[G] \[D]quelque \[G]cho-o-se.
\endverse


\beginchorus
\[C]Ah ! Que son entretien est doux
Qu'il a \[G]de mérite et de gloire
Elle aime à rire, elle aime à \[C]boire
Elle aime à \[G]chanter comme \[C]nous
Elle aime à rire, elle aime à boire
Elle aime à chanter comme nous
Elle aime à \[G]rire, elle \[C]aime à boire
Elle aime à chanter comme nous
Oui, comme nous.
\endchorus
...
\beginverse
G - C - G - D
Fanchon, quoique bonne chrétie-en-ne
Fut baptisée avec du vin
Un Bourguignon fut son parrain
Une Bretonne sa marrai-ai-ne.
\endverse

\beginverse
Fanchon préfère la grilla-a-de
A tous les mets plus délicats
Son teint prend un nouvel éclat
Quand on lui verse une rasa-a-de.
\endverse

\beginverse
Fanchon ne se montre crue-el-le
Que lorqu'on lui parle d'amour
Mais moi, je ne lui fais la cour
Que pour m'enivrer avec e-el-le.
\endverse

\beginverse
Un jour, le voisin La Grena-a-de
Lui mit la main dans le corset
Elle répondit par un soufflet
Sur le museau du camara-a-de.
\endverse
